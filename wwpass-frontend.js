(function () {
	...
	var WebSocketPool = /*#__PURE__*/function () {
	...
	var WWPassError = /*#__PURE__*/function (_Error) {
	  inherits(WWPassError, _Error);

	  var _super = _createSuper(WWPassError);
	  ...
	  function WWPassError(code) {
	    ...
	    _this = _super.call(this, args, WWPassError);
	...
	var WWPassCryptoPromise = /*#__PURE__*/function () {
	  // Private
	  ...
	  createClass(WWPassCryptoPromise, [{
	    ...
	    */
	    function getWWPassCrypto(ticket) {
	...
	*/
	...
	var wwpassPluginExecute = function wwpassPluginExecute(inputRequest) {
	  return new Promise(function (resolve, reject) {
	    ...
	    var request = _objectSpread$1(_objectSpread$1({}, defaultOptions), inputRequest);
	...
	var wwpassNMExecute = function wwpassNMExecute(inputRequest) {
	  ...
	  var request = _objectSpread$2(_objectSpread$2({}, defaultOptions), inputRequest);
	...
	var wwpassAuth = function wwpassAuth(request) {
	  return wwpassCall(wwpassNMExecute, wwpassPluginExecute, _objectSpread$3(_objectSpread$3({}, request), {}, {
	    operation: 'auth'
	  }));
	};
	...
	var getCallbackURL = function getCallbackURL() {
	  ...
	  var options = _objectSpread$4(_objectSpread$4({}, defaultOptions), initialOptions);
	  ...
	  url += firstDelimiter;
	  var callbackParameters = ['version', 'ticket', 'status', 'reason'];
	  ...
	  callbackParameters.forEach(function (name, index) {
	    url += "".concat(encodeURIComponent(options.ppx)).concat(name, "=").concat(encodeURIComponent(options[name])).concat(index === callbackParameters.length - 1 ? '' : '&');
	  });
	  return url;
	};
	...
	var initPasskeyButton = function initPasskeyButton(options, resolve) {
	...
	var wwpassPasskeyAuth = function wwpassPasskeyAuth(initialOptions) {
	  return new Promise(function (resolve, reject) {
	    ...
	    var options = _objectSpread$5(_objectSpread$5({}, defaultOptions), initialOptions);
	...
	*/
	...
	var QRCodeLogin = function QRCodeLogin(parentElement, wwpassURLoptions, ttl, qrcodeStyle, showSwitch) {
	  return new Promise(function (resolve) {
	...
	var haveButtonStyleSheet = false;
	...
	var sameDeviceLogin = function sameDeviceLogin(parentElement, wwpassURLoptions, ttl) {
	  var showSwitch = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : true;
	  return new Promise(function (resolve) {
	    addButtonStyleSheet();
	    var universalLinkElement = document.createElement('a');
	    ...
	    if (wwpassURLoptions) universalLinkElement.href = getUniversalURL(wwpassURLoptions, true);else universalLinkElement.href = '#';
	    var qrCodeSwitchLink = document.createElement('a');
	...
	var redirectToWWPassApp = /*#__PURE__*/function () {
	  var _ref = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee(options, authResult) {
	    var json, response, ticket, ttl, key;
	  ...
	  return function redirectToWWPassApp(_x, _x2) {
	    return _ref.apply(this, arguments);
	  };
	}();

	var appAuth = /*#__PURE__*/function () {
	  var _ref2 = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee2(initialOptions) {
	      ...
	      while (1) {
	        switch (_context2.prev = _context2.next) {
	          case 0:
	            ...
	            options = _objectSpread$6(_objectSpread$6({}, defaultOptions), initialOptions);
	            _context2.next = 4;
	          ...
	          case 4:
	            ...
	            return _context2.abrupt("return", redirectToWWPassApp(options, result));
	  ...
	  return function appAuth(_x3) {
	    return _ref2.apply(this, arguments);
	  };
	}();

	var qrCodeAuth = /*#__PURE__*/function () {
	  var _ref3 = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee3(options, websocketPool) {
	      ...
	      while (1) {
	        switch (_context3.prev = _context3.next) {
	          ...
	          case 10:
	            ...
	            _context3.next = 15;
	            return QRCodeLogin(options.qrcode, wwpassURLoptions, ttl * 900, options.qrcodeStyle, options.uiSwitch === 'auto' && isMobile() || options.uiSwitch === 'always');
	          ...
	          case 15:
	            ...
	            return _context3.abrupt("return", redirectToWWPassApp(options, result));
	          ...
	          case 22:
	            ...
	            if (_context3.t0.status) {
	              _context3.next = 31;
	              break;
	            }

	            options.log('QRCode auth error', _context3.t0); // eslint-disable-next-line no-await-in-loop

	            _context3.next = 28;
	            return setRefersh(options.qrcode, _context3.t0);
	          ...
	          case 31:
	            ...
	            if (!(_context3.t0.status === WWPASS_STATUS.INTERNAL_ERROR || options.returnErrors)) {
	              _context3.next = 34;
	              break;
	            }
	  ...
	  return function qrCodeAuth(_x4, _x5) {
	...
	var wwpassMobileAuth = /*#__PURE__*/function () {
	  var _ref4 = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee4(initialOptions) {
	      ...
	      while (1) {
	        switch (_context4.prev = _context4.next) {
	          case 0:
	            ...
	            options = _objectSpread$6(_objectSpread$6({}, defaultOptions), initialOptions);
	            options.qrcodeStyle = _objectSpread$6(_objectSpread$6({}, defaultOptions.qrcodeStyle), initialOptions.qrcodeStyle);
	          ...
	          case 9:
	            executor = null;
	            _context4.t0 = options.uiType;
	            _context4.next = _context4.t0 === 'button' ? 13 : _context4.t0 === 'qrcode' ? 15 : _context4.t0 === 'auto' ? 17 : 17;
	            break;
	  ...
	  return function wwpassMobileAuth(_x6) {
	...
	var openWithTicket = function openWithTicket(initialOptions) {
	  return new Promise(function (resolve) {
	    ...
	    var options = _objectSpread$7(_objectSpread$7({}, defaultOptions), initialOptions);
	...
	var authInit = function authInit(initialOptions) {
	  ...
	  var options = _objectSpread$8(_objectSpread$8({}, defaultOptions), initialOptions);
